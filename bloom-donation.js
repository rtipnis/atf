...
'      <h3>Donation</h3>' +
'      <div class="field radio 910336 required" >' +
'<label for="910336"><input id="910336" name="donation-level" class="required" type="radio" value="10000.000000" maxlength="255"></input><span class="label">$10,000.00 - Full academic sponsorship</span></label>' +
'</div>' +
'<div class="field radio 910337 required" >' +
'<label for="910337"><input id="910337" name="donation-level" class="required" type="radio" value="7000.000000" maxlength="255"></input><span class="label">$7,000.00 - Tuition for academic year</span></label>' +
'</div>' +
'<div class="field radio 910338 required" >' +
'<label for="910338"><input id="910338" name="donation-level" class="required" type="radio" value="6000.000000" maxlength="255"></input><span class="label">$6,000.00 - Meal plan for academic year</span></label>' +
'</div>' +
'<div class="field radio 910339 required" >' +
'<label for="910339"><input id="910339" name="donation-level" class="required" type="radio" value="6000.000000" maxlength="255"></input><span class="label">$6,000.00 - STEM summer research internship</span></label>' +
'</div>' +
'<div class="field radio 910340 required" >' +
'<label for="910340"><input id="910340" name="donation-level" class="required" type="radio" value="5000.000000" maxlength="255"></input><span class="label">$5,000.00 - Semester academic sponsorship</span></label>' +
'</div>' +
'<div class="field radio 910341 required" >' +
'<label for="910341"><input id="910341" name="donation-level" class="required" type="radio" value="3500.000000" maxlength="255"></input><span class="label">$3,500.00 - Tuition for semester</span></label>' +
'</div>' +
'<div class="field radio 910342 required" >' +
'<label for="910342"><input id="910342" name="donation-level" class="required" type="radio" value="3000.000000" maxlength="255"></input><span class="label">$3,000.00 - Meal plan for a semester</span></label>' +
'</div>' +
'<div class="field radio 910343 required" >' +
'<label for="910343"><input id="910343" name="donation-level" class="required" type="radio" value="1600.000000" maxlength="255"></input><span class="label">$1,600.00 - Tutoring for academic year</span></label>' +
'</div>' +
'<div class="field radio 910344 required" >' +
'<label for="910344"><input id="910344" name="donation-level" class="required" type="radio" value="1500.000000" maxlength="255"></input><span class="label">$1,500.00 - Computer and technology supplies</span></label>' +
'</div>' +
'<div class="field radio 910345 required" >' +
'<label for="910345"><input id="910345" name="donation-level" class="required" type="radio" value="1500.000000" maxlength="255"></input><span class="label">$1,500.00 - College books & supplies for full year</span></label>' +
'</div>' +
'<div class="field radio 910346 required" >' +
'<label for="910346"><input id="910346" name="donation-level" class="required" type="radio" value="800.000000" maxlength="255"></input><span class="label">$800.00 - Tutoring for semester</span></label>' +
'</div>' +
'<div class="field radio 910347 required" >' +
'<label for="910347"><input id="910347" name="donation-level" class="required" type="radio" value="750.000000" maxlength="255"></input><span class="label">$750.00 - College books and supplies for semester</span></label>' +
'</div>' +
'<div class="field radio 910348 required" >' +
'<label for="910348"><input id="910348" name="donation-level" class="required" type="radio" value="600.000000" maxlength="255"></input><span class="label">$600.00 - Transportation for summer intership</span></label>' +
'</div>' +
'<div class="field radio 910349 required" >' +
'<label for="910349"><input id="910349" name="donation-level" class="required" type="radio" value="400.000000" maxlength="255"></input><span class="label">$400.00 - Parking pass for academic year</span></label>' +
'</div>' +
'<div class="field radio 910350 required" >' +
'<label for="910350"><input id="910350" name="donation-level" class="required" type="radio" value="250.000000" maxlength="255"></input><span class="label">$250.00 - Industry Forums and conferences</span></label>' +
'</div>' +
'<div class="field radio 910351 required" >' +
'<label for="910351"><input id="910351" name="donation-level" class="required" type="radio" value="200.000000" maxlength="255"></input><span class="label">$200.00 - Parking pass for semester</span></label>' +
'</div>' +
'<div class="field radio 910352 required" >' +
'<label for="910352"><input id="910352" name="donation-level" class="required" type="radio" value="50.000000" maxlength="255"></input><span class="label">$50.00 - Holiday gift card for scholar</span></label>' +
'</div>' +
...
'<label for="consent-all"><input id="consent-all" name="consent-all" type="checkbox" maxlength="255"></input><span class="label">I would like to receive or continue receiving updates from Anaya Tipnis Foundation, Inc.</span></label>' +
'</div>' +
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha907264"></div>' +
'' +
'</div>' +
'    <div class="btn-group">' +
...
'</div>' +
'' +
'' +  '';var successHtml907264 = '<div class=\'donation-success\'>' +
                                                       '  <h2>Thank You for Your Donation!</h2>' +
                                                       '  <p>Your generous gift has been processed. We truly appreciate your continued support.</p>' +
                                                        '   ' +
                                                        '</div>';( function($) {if (Bloomerang.useDonationId('907264')) {
                                Bloomerang.useProcessor('905217', 'StripeExpress', 'pk_live_iZYXFefCkt380zu63aqUIo7y');
                            } else {
                                html907264 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                            }if (jQuery('#bloomerangForm907264').length) {
                       
                    if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                        html907264 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' +
                        ...
                        jQuery('#bloomerangForm907264').after(html907264);
                       
                         Bloomerang.Util.requireStripe(function() {
                              Bloomerang.Util.Stripe = Stripe('pk_live_iZYXFefCkt380zu63aqUIo7y');

                              Bloomerang.useKey('pub_c910a92c-71a6-11ee-a6f2-0a4cd6191fc9');
                        ...
                        Bloomerang.Util.requirePayPal('AbhrJjDZYrv1QNO_ZLVf6XpZky3SZjtvREbPF07KssBteJ-TKfH23tl5cm0KwXGme7ayVHOK7HGMd4q-', function() {
                         Bloomerang.Util.IsPayPalVenmoEnabled = true;
                         Bloomerang.Util.mountPayPalVenmoElements();
                         Bloomerang.paypalProcessorAccountId = 'HZD4HP299MVTA';
                         Bloomerang.paypalPartnerFeeId = 'DGXFVX3EJBNXU'
                       });
                       ...
                       window.captchaLoadCallback = function() {
                        ...
                        Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                            ...
                            function() {
                                ...
                                jQuery('form.donation-form').data('captcha-id', grecaptcha.render('captcha907264', { 'sitekey' : '6LfSlbIpAAAAAOcXtUjFA44pittu3u7BQWhaHllG' }));
                            },
                            true,
                            true);
       ...
       jQuery('html, body').animate({ scrollTop : offsetTop}, 500);
        ...
        Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
            ...
            formContainer.show();
            formContainer.html(successHtml907264);
              ...
              jQuery(e).toggle();
                ...
                var startBloomerangLoad = function() {
                    if (window.bloomerangLoadStarted == undefined) {
                        ...
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm907264(); })});
                    }
                    else {
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm907264(); })});
                    }
